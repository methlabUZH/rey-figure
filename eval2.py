...
def main():
    ...
    out_file = os.path.join(args.results_dir, 'eval2.txt' if not DEBUG else 'debug_eval2.txt')
    ...
    dataloader = get_eval_dataloader(args.data_root, labels_df=labels, batch_size=args.batch_size,
