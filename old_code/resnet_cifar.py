...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = nn.Conv2d(planes, planes, kernel_size=(3, 3), stride=(stride, stride), padding=1, bias=False)
        self.bn2 = nn.BatchNorm2d(planes)
...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, n_outputs, block_name='BasicBlock'):
        ...
        # self.avgpool = nn.AvgPool2d(kernel_size=(29, 38))
