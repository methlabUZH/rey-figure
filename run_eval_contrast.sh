...
for contrast in $(seq 0.1 0.1 2.0); do
  python eval_multilabel_semantic.py --results-dir $RES_DIR1 --transform "contrast" --contrast $contrast
  python eval_multilabel_semantic.py --results-dir $RES_DIR2 --transform "contrast" --contrast $contrast
done
