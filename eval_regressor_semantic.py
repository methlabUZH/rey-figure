...
def main():
    ...
    num_classes = train_args.get('n_classes', 4)
    ...
    evaluator = SemanticRegressionEvaluator(model=model, image_size=image_size, results_dir=args.results_dir,
