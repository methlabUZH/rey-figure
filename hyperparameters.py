...
train_params = {
    ...
    '232 300': {
        'multilabel-classifier': {
            ...
            "id": "final", "epochs": 75, "batch_size": 16, "lr": 0.01, "gamma": 0.95, "wd": 0,
    ...
    '348 450': {
        'multilabel-classifier': {
            "simulated_data": None, "max_simulated": -1, "workers": 8, "is_binary": 0, "eval_test": True,
            "id": "final", "epochs": 75, "batch_size": 8, "lr": 0.01, "gamma": 0.95, "wd": 0,
            "weighted_sampling": 1, "augment": 0, "image_size": [348, 450]
        },
        'regressor': {
            "simulated_data": None, "max_simulated": -1, "workers": 8, "is_binary": 0, "eval_test": True,
            "id": "final", "epochs": 75, "batch_size": 8, "lr": 0.01, "gamma": 0.95, "wd": 0,
