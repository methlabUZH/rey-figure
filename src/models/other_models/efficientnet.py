...
__all__ = ['efficientnet_b0', 'efficientnet_b4', 'efficientnet_b8', 'efficientnet_l2', 'EfficientNet']
...
class MBConvBlock(nn.Module):
    ...
    Args:
        block_args (namedtuple): BlockArgs, defined in dataloaders.py.
        global_params (namedtuple): GlobalParam, defined in dataloaders.py.
...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        for block_args in self._blocks_args:
            ...
            block_args = block_args._replace(  # noqa
        ...
        # Head
        in_channels = block_args.output_filters  # output of final block # noqa
        ...
        if self._global_params.include_top:
            ...
            self._fc = nn.Linear(out_channels, self._global_params._NUM_CLASSES)
