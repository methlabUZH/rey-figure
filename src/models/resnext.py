...
this code is adapted from: 
    https://raw.githubusercontent.com/bearpaw/pytorch-classification/master/models/imagenet/resnext.py
by Wei Yang
...
class ResNeXt(nn.Module):
    ...
    def __init__(self, baseWidth, cardinality, layers, n_outputs):
        """ Constructor
        Args:
        ...
        self.avgpool = nn.AvgPool2d(kernel_size=(4, 5))
