...
Results and logging 
"""
config['results_dir'] = '/home/ubuntu/projects/rey-figure/results/data_232x300-seed_1/final-bigsize/rey-multilabel-classifier' #'./results' # set to model directory for evaluation 
